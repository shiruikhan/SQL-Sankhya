...
/*==============================================================================
  Nome do Script : STP_ALTDADOSPRO_SPARK
  Tipo           : Stored Procedure (Botão de Ação)
  Descrição      : Atualiza parâmetros de produto em lote (fornecedor, leadtime,
                   estoques mínimo/máximo, agrupamento mínimo) com base em parâmetros
                   informados pelo usuário na tela de ação.
