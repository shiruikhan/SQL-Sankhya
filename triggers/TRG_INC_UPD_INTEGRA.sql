    ...
    IF :NEW.CODPARC IS NULL THEN
        ...
        BEGIN            
            ...
            INSERT INTO TGFPAR (
                ...
                CODBAI, CODCID, EMAIL, EMAILNFE, RAZAOSOCIAL, CLASSIFICMS, TEMIPI, TIPANEXONFE, EMAILDANFE, IPIINCICMS, DTCAD, DTALTER, APLICLEITRANSP
            )
            VALUES (
                v_codparc, 'F', 'ISENTO', UPPER(:NEW.RAZAOSOCIAL), :NEW.DOCUMENTO, 'S', 'S', :NEW.CEP, :NEW.CODEND, :NEW.NUMERO, :NEW.COMPLEMENTO,
                :NEW.CODBAI, :NEW.CODCID, :NEW.EMAIL, :NEW.EMAIL, UPPER(:NEW.RAZAOSOCIAL), 'C', 'S', 'X', 'S', 'S', SYSDATE, SYSDATE, 'S'
            );
